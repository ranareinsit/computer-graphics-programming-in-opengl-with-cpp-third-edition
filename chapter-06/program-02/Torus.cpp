...
constexpr glm::mat4 ident = glm::mat4(1.0f);
...
void Torus::init() {
	...
	for (int i = 0; i < prec + 1; i++) {
		...
		glm::mat4 rMat = glm::rotate(ident, amt, glm::vec3(0.0f, 0.0f, 1.0f));
		...
		rMat = glm::rotate(ident, amt + (pi / 2.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	for (int ring = 1; ring < prec + 1; ring++) {
		for (int i = 0; i < prec + 1; i++) {
			...
			glm::mat4 rMat = glm::rotate(ident, amt, glm::vec3(0.0f, 1.0f, 0.0f));
			...
			rMat = glm::rotate(ident, amt, glm::vec3(0.0f, 1.0f, 0.0f));
