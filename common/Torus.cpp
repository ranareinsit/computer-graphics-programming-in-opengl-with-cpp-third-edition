...
void Torus::init() {
	...
	for (size_t i = 0; i < numVertices; i++) { vertices.push_back(glm::vec3()); }
	for (size_t i = 0; i < numVertices; i++) { texCoords.push_back(glm::vec2()); }
	for (size_t i = 0; i < numVertices; i++) { normals.push_back(glm::vec3()); }
	for (size_t i = 0; i < numVertices; i++) { sTangents.push_back(glm::vec3()); }
	for (size_t i = 0; i < numVertices; i++) { tTangents.push_back(glm::vec3()); }
	...
	for (size_t ring = 1; ring < prec + 1; ring++) {
		for (size_t i = 0; i < prec + 1; i++) {
