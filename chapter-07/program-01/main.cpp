...
void display(GLFWwindow* window, double currentTime) {
	...
	mMat = eulerRotation(vMat, fct , fct , fct );
	installLights(vMat);
	mvMat = vMat * mMat;
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "program 0701", NULL, NULL);
