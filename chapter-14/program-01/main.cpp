...
void init(GLFWwindow* window) {
	...
	setupVertices();
	rockyTexture = Utils::loadTexture("texture.jpg");
	heightMap = Utils::loadTexture("DisplacementMap.png");
}
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(1000, 600, "program 1401", NULL, NULL);
