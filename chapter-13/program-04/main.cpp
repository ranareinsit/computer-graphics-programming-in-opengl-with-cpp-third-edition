...
glm::vec3 currentLightPos, lightLoc(2.0f, 2.0f, 3.0f); // Initialize lightLoc here
int width, height;
...
void installLights(glm::mat4 vMatrix) {
    glm::vec3 transformed = glm::vec3(vMatrix * glm::vec4(currentLightPos, 1.0f)); // Apply transformation
