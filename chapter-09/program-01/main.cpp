...
void display(GLFWwindow* window, double currentTime) {
	...
	mMat = glm::rotate(mMat, (float)currentTime / 2, glm::vec3(0.0f, 1.0f, 0.0f));
	mvMat = vMat * mMat;
	...
	mMat = glm::rotate(mMat, (float)currentTime / 3, glm::vec3(0.0f, 1.0f, 0.0f));
	mvMat = vMat * mMat;
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "program 0901", NULL, NULL);
